...
<body>
    <div class="col-lg-5 mr-auto">
        <form action="index.php?controller=films&action=maj" method="post">
            ...
            Nom: <input type="text" name="nom" value="<?php echo $data["film"]->Film_nom ?>" class="form-control" />
            Sortie: <input type="text" name="prix" value="<?php echo $data["film"]->Date_sortie ?>" class="form-control" />
            Realisateur: <input type="text" name="poid" value="<?php echo $data["film"]->Realisateur ?>" class="form-control" />
